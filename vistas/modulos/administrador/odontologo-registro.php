<section class="row">
        <div class="col-md-12">
          ...
          <form action="http://localhost/WEBSERVICES/registrarOdontologos" method="POST">
            ...
            <div class="form-row justify-content-around">
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-md-7">
                    <input type="text" class="form-control" id="segundo_apellido" placeholder="Ingrese su segundo apellido" name="segundo-apellido">
                  </div>
                </div>                
              </div>
              <div class="col-md-6">
